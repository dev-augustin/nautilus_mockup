        ...
        <React.Fragment> 
            <div class="container">
                <div class="image1" id="img1">
                    ...
                    <img src={bioImg} alt="dgdd" height='200px' width="300px" class="img"/>
                    <h5>Making Sense of the Genome, at Last<br/><em>by Adam Pierre</em></h5>
                </div>
                <div class="image2" id="img2">
                    <h3 id="women_sci">
                       Women in Science & Enginerring </h3>
                    <img src={wise_sciImg} alt="sdfsd" height='200px' width="300px" class="img"/>
